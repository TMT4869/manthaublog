...
public class RejectPostHandler {
    ...
    @Transactional
    public void handle(UUID postId, RejectPostRequest req, UserPrincipal admin) {
        ...
        post.setRejectionReason(req.reason());
        ...
        eventPublisher.publishRejected(postId, post.getAuthorId(), req.reason());
    }
}
